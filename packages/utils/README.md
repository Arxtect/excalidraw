...
```bash
npm install @pageflux/utils
```

If you prefer Yarn over npm, use this command to install the Excalidraw utils package:

```bash
yarn add @pageflux/utils
```
...
```js
import { exportToSvg, exportToBlob } from "@pageflux/utils";
```

To use it in a browser directly:

```html
<script src="https://unpkg.com/@pageflux/utils@0.1.0/dist/excalidraw-utils.min.js"></script>
<script>
