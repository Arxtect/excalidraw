...
slug: /@pageflux/excalidraw/api/children-components
---
...
- [MainMenu](/docs/@pageflux/excalidraw/api/children-components/main-menu)
- [WelcomeScreen](/docs/@pageflux/excalidraw/api/children-components/welcome-screen)
- [Sidebar](/docs/@pageflux/excalidraw/api/children-components/sidebar)
- [Footer](/docs/@pageflux/excalidraw/api/children-components/footer)
- [LiveCollaborationTrigger](/docs/@pageflux/excalidraw/api/children-components/live-collaboration-trigger)
