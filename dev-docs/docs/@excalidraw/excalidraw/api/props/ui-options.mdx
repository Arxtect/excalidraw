...
| `toggleTheme` | `boolean` &#124; `null` | `null` | Indicates whether to show `Theme toggle`. When defined as `boolean`, takes precedence over [`props.theme`](/docs/@pageflux/excalidraw/api/props#theme) to show `Theme toggle`. |
