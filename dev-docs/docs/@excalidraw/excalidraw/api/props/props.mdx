...
| --- | --- | --- | --- |
| [`initialData`](/docs/@pageflux/excalidraw/api/props/initialdata) | `object` &#124; `null` &#124; <code>Promise<object &#124; null></code> | `null` | The initial data with which app loads. |
| [`excalidrawAPI`](/docs/@pageflux/excalidraw/api/props/excalidraw-api) | `function` | \_ | Callback triggered with the excalidraw api once rendered |
...
| [`renderTopRightUI`](/docs/@pageflux/excalidraw/api/props/render-props#rendertoprightui) | `function` | \_ | Render function that renders custom UI in top right corner |
| [`renderCustomStats`](/docs/@pageflux/excalidraw/api/props/render-props#rendercustomstats) | `function` | \_ | Render function that can be used to render custom stats on the stats dialog. |
...
| [`UIOptions`](/docs/@pageflux/excalidraw/api/props/ui-options) | `object` | [DEFAULT UI OPTIONS](https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/constants.ts#L151) | To customise UI options. Currently we support customising [`canvas actions`](/docs/@pageflux/excalidraw/api/props/ui-options#canvasactions) |
...
| [`renderEmbeddable`](/docs/@pageflux/excalidraw/api/props/render-props#renderEmbeddable) | `function` | \_ | Render function that can override the built-in `<iframe>` |
...
You can add `customData` to elements when passing them as [`initialData`](/docs/@pageflux/excalidraw/api/props/initialdata), or using [`updateScene`](/docs/@pageflux/excalidraw/api/props/excalidraw-api#updatescene) / [`updateLibrary`](/docs/@pageflux/excalidraw/api/props/excalidraw-api#updatelibrary) afterwards.
...
You can use [`THEME`](/docs/@pageflux/excalidraw/api/utils#theme) to specify the theme.
