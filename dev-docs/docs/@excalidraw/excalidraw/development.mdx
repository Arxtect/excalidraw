---
pagination_prev: "@pageflux/excalidraw/installation"
---

# Development

This page relates to developing the `@pageflux/excalidraw` package itself.

## Example app

To start the example app using the `@pageflux/excalidraw` package, follow the below steps:
